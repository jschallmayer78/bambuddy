export default {
  ...
  printers: {
    addPreflight: {
      ...
      unreachable: "L'imprimante n'a pas répondu à cette adresse.",
    },
    title: 'Imprimantes',
    ...
    modal: {
      ...
      serialLabelOptional: 'Numéro de série (facultatif)',
      serialU1Placeholder: "Laisser vide pour le déduire de l'adresse IP",
      serialU1Help: "Simple libellé unique pour cette imprimante : une U1 n'a pas de numéro de série.",
      moonrakerToken: 'Jeton API Moonraker (facultatif)',
      moonrakerTokenPlaceholder: 'Uniquement si votre Moonraker en exige un',
  ...
  diagnostic: {
    ...
    check: {
      ...
      moonraker: {
        title: "API de l'imprimante (Moonraker)",
        pass: "L'imprimante a répondu : Bambuddy peut lire son état et lui envoyer des commandes.",
        fail: "Aucune réponse de l'imprimante à cette adresse ({{error}}). Vérifiez qu'elle est allumée, sur le même réseau et joignable à l'adresse configurée ici.",
      },
      snapmaker_identity: {
        title: 'Micrologiciel Snapmaker',
        pass: 'Identifiée comme une Snapmaker {{machine_type}}.',
        pass_unknown: 'Identifiée comme un micrologiciel Snapmaker.',
        warn: "L'imprimante a répondu mais ne se présente pas comme une Snapmaker, signe habituel d'un micrologiciel communautaire. L'état et les commandes de base devraient continuer à fonctionner ; certaines fonctions propres à la U1 peut-être pas.",
        skip: "Non vérifié : l'imprimante était injoignable.",
      },
      klipper_ready: {
        title: 'Micrologiciel prêt (Klipper)',
        pass: 'Le micrologiciel est prêt et accepte les commandes.',
        fail: "Le micrologiciel signale « {{state}} » au lieu d'être prêt. Il est arrêté et refusera toute commande jusqu'à son redémarrage : lancez FIRMWARE_RESTART depuis l'écran de l'imprimante, ou redémarrez-la.",
        fail_error: "L'état du micrologiciel n'a pas pu être lu ({{error}}). L'imprimante a répondu, pas son micrologiciel : redémarrez-la puis relancez la vérification.",
        skip: "Non vérifié : l'imprimante était injoignable.",
      },
    },
  },
