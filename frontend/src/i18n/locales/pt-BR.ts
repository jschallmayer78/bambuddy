export default {
  ...
  printers: {
    addPreflight: {
      ...
      unreachable: 'A impressora não respondeu nesse endereço.',
    },
    title: 'Impressoras',
    ...
    modal: {
      ...
      serialLabelOptional: 'Número de série (opcional)',
      serialU1Placeholder: 'Deixe em branco para derivar do endereço IP',
      serialU1Help: 'Apenas um rótulo único para esta impressora — a U1 não tem número de série.',
      moonrakerToken: 'Token de API do Moonraker (opcional)',
      moonrakerTokenPlaceholder: 'Somente se o seu Moonraker exigir',
  ...
  diagnostic: {
    ...
    check: {
      ...
      moonraker: {
        title: 'API da impressora (Moonraker)',
        pass: 'A impressora respondeu — o Bambuddy consegue ler o status e enviar comandos.',
        fail: 'Sem resposta da impressora neste endereço ({{error}}). Verifique se ela está ligada, na mesma rede e acessível no endereço configurado aqui.',
      },
      snapmaker_identity: {
        title: 'Firmware Snapmaker',
        pass: 'Identificada como uma Snapmaker {{machine_type}}.',
        pass_unknown: 'Identificada como firmware Snapmaker.',
        warn: 'A impressora respondeu, mas não se identifica como uma Snapmaker — normalmente sinal de firmware da comunidade. Status e controle básico devem continuar funcionando; alguns recursos específicos da U1 podem não funcionar.',
        skip: 'Não verificado — não foi possível alcançar a impressora.',
      },
      klipper_ready: {
        title: 'Firmware pronto (Klipper)',
        pass: 'O firmware está pronto e aceitando comandos.',
        fail: 'O firmware informa “{{state}}” em vez de pronto. Ele parou e vai recusar qualquer comando até ser reiniciado — execute FIRMWARE_RESTART na tela da impressora ou desligue e ligue a impressora.',
        fail_error: 'Não foi possível ler o estado do firmware ({{error}}). A impressora respondeu, mas o firmware não — reinicie-a e rode a verificação de novo.',
        skip: 'Não verificado — não foi possível alcançar a impressora.',
      },
    },
  },
