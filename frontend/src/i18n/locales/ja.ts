export default {
  ...
  printers: {
    addPreflight: {
      ...
      back: '戻る',
      saveAnyway: 'そのまま保存',
      unreachable: 'そのアドレスではプリンターから応答がありませんでした。',
    },
    title: 'プリンター',
    addPrinter: 'プリンターを追加',
    printerType: {
    ...
    modal: {
      ...
      serialLabelOptional: 'シリアル番号（任意）',
      serialU1Placeholder: '空欄にするとIPアドレスから生成します',
      serialU1Help: 'このプリンターを識別するためのラベルです。U1にシリアル番号はありません。',
      moonrakerToken: 'Moonraker APIトークン（任意）',
      moonrakerTokenPlaceholder: 'Moonrakerが要求する場合のみ',
  ...
  diagnostic: {
    ...
    check: {
      ...
      moonraker: {
        title: 'プリンターAPI（Moonraker）',
        pass: 'プリンターが応答しました。Bambuddyから状態の取得とコマンド送信ができます。',
        fail: 'このアドレスのプリンターから応答がありません（{{error}}）。電源が入っているか、同じネットワークにあるか、ここで設定したアドレスで到達できるかを確認してください。',
      },
      snapmaker_identity: {
        title: 'Snapmakerファームウェア',
        pass: 'Snapmaker {{machine_type}} として認識されました。',
        pass_unknown: 'Snapmakerのファームウェアとして認識されました。',
        warn: 'プリンターは応答しましたが、Snapmakerとして名乗っていません。多くはコミュニティ製ファームウェアです。状態表示と基本的な操作は動作しますが、U1固有の機能は使えない場合があります。',
        skip: '未確認 — プリンターに接続できませんでした。',
      },
      klipper_ready: {
        title: 'ファームウェア準備完了（Klipper）',
        pass: 'ファームウェアは準備完了で、コマンドを受け付けます。',
        fail: 'ファームウェアの状態が「{{state}}」で、準備完了ではありません。停止しており、再起動するまですべてのコマンドを拒否します。プリンターの画面からFIRMWARE_RESTARTを実行するか、電源を入れ直してください。',
        fail_error: 'ファームウェアの状態を読み取れませんでした（{{error}}）。プリンター自体は応答していますがファームウェアが応答していません。再起動してからもう一度確認してください。',
        skip: '未確認 — プリンターに接続できませんでした。',
      },
    },
  },
