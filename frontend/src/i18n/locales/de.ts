export default {
  ...
  printers: {
    addPreflight: {
      ...
      unreachable: 'Der Drucker hat unter dieser Adresse nicht geantwortet.',
    },
    title: 'Drucker',
    ...
    modal: {
      ...
      serialLabelOptional: 'Seriennummer (optional)',
      serialU1Placeholder: 'Leer lassen, um sie aus der IP-Adresse abzuleiten',
      serialU1Help: 'Nur eine eindeutige Bezeichnung für diesen Drucker — ein U1 hat keine Seriennummer.',
      moonrakerToken: 'Moonraker-API-Token (optional)',
      moonrakerTokenPlaceholder: 'Nur falls dein Moonraker eines verlangt',
  ...
  diagnostic: {
    ...
    check: {
      ...
      moonraker: {
        title: 'Drucker-API (Moonraker)',
        pass: 'Der Drucker hat geantwortet — Bambuddy kann seinen Status lesen und Befehle senden.',
        fail: 'Keine Antwort vom Drucker unter dieser Adresse ({{error}}). Prüfen Sie, ob er eingeschaltet, im selben Netzwerk und unter der hier eingetragenen Adresse erreichbar ist.',
      },
      snapmaker_identity: {
        title: 'Snapmaker-Firmware',
        pass: 'Als Snapmaker {{machine_type}} erkannt.',
        pass_unknown: 'Als Snapmaker-Firmware erkannt.',
        warn: 'Der Drucker hat geantwortet, meldet sich aber nicht als Snapmaker — meist ein Hinweis auf Community-Firmware. Status und grundlegende Steuerung sollten weiterhin funktionieren, einzelne U1-Funktionen möglicherweise nicht.',
        skip: 'Nicht geprüft — der Drucker war nicht erreichbar.',
      },
      klipper_ready: {
        title: 'Firmware bereit (Klipper)',
        pass: 'Die Firmware ist bereit und nimmt Befehle an.',
        fail: 'Die Firmware meldet „{{state}}“ statt bereit. Sie ist angehalten und lehnt jeden Befehl ab, bis sie neu gestartet wird — führen Sie FIRMWARE_RESTART am Druckerdisplay aus oder starten Sie den Drucker neu.',
        fail_error: 'Der Firmware-Status konnte nicht gelesen werden ({{error}}). Der Drucker hat geantwortet, seine Firmware nicht — starten Sie ihn neu und führen Sie die Prüfung erneut aus.',
        skip: 'Nicht geprüft — der Drucker war nicht erreichbar.',
      },
    },
  },
