export default {
  ...
  printers: {
    addPreflight: {
      ...
      unreachable: 'La impresora no respondió en esa dirección.',
    },
    title: 'Impresoras',
    ...
    modal: {
      ...
      serialLabelOptional: 'Número de serie (opcional)',
      serialU1Placeholder: 'Déjalo vacío para derivarlo de la dirección IP',
      serialU1Help: 'Solo una etiqueta única para esta impresora: una U1 no tiene número de serie.',
      moonrakerToken: 'Token de API de Moonraker (opcional)',
      moonrakerTokenPlaceholder: 'Solo si tu Moonraker lo requiere',
  ...
  diagnostic: {
    ...
    check: {
      ...
      moonraker: {
        title: 'API de la impresora (Moonraker)',
        pass: 'La impresora respondió: Bambuddy puede leer su estado y enviarle comandos.',
        fail: 'La impresora no responde en esta dirección ({{error}}). Comprueba que está encendida, conectada a la misma red y accesible en la dirección configurada aquí.',
      },
      snapmaker_identity: {
        title: 'Firmware de Snapmaker',
        pass: 'Identificada como una Snapmaker {{machine_type}}.',
        pass_unknown: 'Identificada como firmware de Snapmaker.',
        warn: 'La impresora respondió pero no se identifica como una Snapmaker, lo que suele indicar firmware de la comunidad. El estado y el control básico deberían seguir funcionando; algunas funciones específicas de la U1 quizá no.',
        skip: 'Sin comprobar: no se pudo contactar con la impresora.',
      },
      klipper_ready: {
        title: 'Firmware listo (Klipper)',
        pass: 'El firmware está listo y acepta comandos.',
        fail: 'El firmware informa «{{state}}» en lugar de estar listo. Se ha detenido y rechazará cualquier comando hasta que se reinicie: ejecuta FIRMWARE_RESTART desde la pantalla de la impresora o reiníciala.',
        fail_error: 'No se pudo leer el estado del firmware ({{error}}). La impresora respondió, pero su firmware no: reiníciala y vuelve a ejecutar la comprobación.',
        skip: 'Sin comprobar: no se pudo contactar con la impresora.',
      },
    },
  },
