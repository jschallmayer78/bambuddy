export default {
  ...
  printers: {
    addPreflight: {
      ...
      unreachable: "La stampante non ha risposto a quell'indirizzo.",
    },
    title: 'Stampanti',
    addPrinter: 'Aggiungi Stampante',
    printerType: {
      label: 'Tipo di stampante',
      bambu: 'Bambu Lab',
      snapmakerU1: 'Snapmaker U1',
    },
    toolheads: 'Teste di stampa',
    ...
    modal: {
      ...
      serialLabelOptional: 'Numero di serie (facoltativo)',
      serialU1Placeholder: "Lascia vuoto per ricavarlo dall'indirizzo IP",
      serialU1Help: "Solo un'etichetta univoca per questa stampante: una U1 non ha numero di serie.",
      moonrakerToken: 'Token API Moonraker (facoltativo)',
      moonrakerTokenPlaceholder: 'Solo se il tuo Moonraker lo richiede',
  ...
  diagnostic: {
    ...
    check: {
      ...
      moonraker: {
        title: 'API della stampante (Moonraker)',
        pass: 'La stampante ha risposto: Bambuddy può leggerne lo stato e inviarle comandi.',
        fail: "Nessuna risposta dalla stampante a questo indirizzo ({{error}}). Verifica che sia accesa, sulla stessa rete e raggiungibile all'indirizzo configurato qui.",
      },
      snapmaker_identity: {
        title: 'Firmware Snapmaker',
        pass: 'Identificata come una Snapmaker {{machine_type}}.',
        pass_unknown: 'Identificata come firmware Snapmaker.',
        warn: 'La stampante ha risposto ma non si identifica come una Snapmaker: di solito indica un firmware della comunità. Stato e controlli di base dovrebbero continuare a funzionare; alcune funzioni specifiche della U1 forse no.',
        skip: 'Non verificato: la stampante non è stata raggiunta.',
      },
      klipper_ready: {
        title: 'Firmware pronto (Klipper)',
        pass: 'Il firmware è pronto e accetta comandi.',
        fail: 'Il firmware segnala «{{state}}» invece di pronto. Si è arrestato e rifiuterà ogni comando finché non viene riavviato: esegui FIRMWARE_RESTART dallo schermo della stampante oppure spegnila e riaccendila.',
        fail_error: 'Non è stato possibile leggere lo stato del firmware ({{error}}). La stampante ha risposto, il suo firmware no: riavviala ed esegui di nuovo il controllo.',
        skip: 'Non verificato: la stampante non è stata raggiunta.',
      },
    },
  },
