export default {
  ...
  printers: {
    ...
    addPreflight: {
      ...
      unreachable: 'The printer did not answer at that address.',
    },
    ...
    modal: {
      ...
      serialLabelOptional: 'Serial Number (optional)',
      serialU1Placeholder: 'Leave blank to derive it from the IP address',
      serialU1Help: 'Only a unique label for this printer — a U1 has no serial number to read off the machine.',
      moonrakerToken: 'Moonraker API Token (optional)',
      moonrakerTokenPlaceholder: 'Only if your Moonraker requires one',
  ...
  diagnostic: {
    ...
    check: {
      ...
      moonraker: {
        ...
        pass: 'The printer answered — Bambuddy can read its status and send commands.',
        fail: 'No answer from the printer at this address ({{error}}). Check that it is powered on, connected to the same network, and reachable at the address configured here.',
      },
      snapmaker_identity: {
        title: 'Snapmaker firmware',
        pass: 'Identified as a Snapmaker {{machine_type}}.',
        pass_unknown: 'Identified as Snapmaker firmware.',
        warn: 'The printer answered but does not identify itself as a Snapmaker — usually a sign of community firmware. Status and basic control should still work; some U1-specific features may not.',
        skip: 'Not checked — the printer could not be reached.',
      },
      klipper_ready: {
        title: 'Firmware ready (Klipper)',
        pass: 'The firmware is ready and accepting commands.',
        fail: 'The firmware reports “{{state}}” instead of ready. It has halted and will refuse every command until it is restarted — run FIRMWARE_RESTART from the printer screen, or power-cycle the printer.',
        fail_error: 'The firmware state could not be read ({{error}}). The printer answered but its firmware did not — restart it and run the check again.',
        skip: 'Not checked — the printer could not be reached.',
      },
    },
  },
